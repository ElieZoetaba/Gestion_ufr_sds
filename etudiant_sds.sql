...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3327479169ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr_sds&table=etudiant_sds">`ufr_sds`.`etudiant_sds`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr_sds&table=tuteur">`ufr_sds`.`tuteur`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ufr_sds&table=admin_ufr">`ufr_sds`.`admin_ufr`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin_auf&table=admin">`admin_auf`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin_auf&table=abonnes">`admin_auf`.`abonnes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=admin_auf&table=autent">`admin_auf`.`autent`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inscription&table=admin_table">`inscription`.`admin_table`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inscription&table=batabase">`inscription`.`batabase`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inscription&table=user_table">`inscription`.`user_table`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7369747d26262e5a53233a51483b5146">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="ufr_sds" targettable="etudiant_sds">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `etudiant_sds`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ufr_sds" targettable="tuteur">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tuteur`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ufr_sds" targettable="etudiant_sds">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `tuteur`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ufr_sds" targettable="admin_ufr">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `admin_ufr`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ufr_sds" targettable="etudiant_sds">
                            <div class="action_content">
